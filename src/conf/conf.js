...
const conf = {
    ...
    appwriteCollectionId: String(import.meta.env?.VITE_APPWRITE_COLLECTION_ID || process.env.VITE_APPWRITE_COLLECTION_ID),
    appwriteBucketId: String(import.meta.env?.VITE_APPWRITE_BUCKET_ID || process.env.VITE_APPWRITE_BUCKET_ID),
    // aiblogeneratorkey: String(import.meta.env?.VITE_CEREBRAS_API_KEY || process.env.VITE_CEREBRAS_API_KEY)
};
